...
template <> constexpr inline auto AdminDashboard::qt_create_metaobjectdata<qt_meta_tag_ZN14AdminDashboardE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        ...
        "onAssignInstructorClicked",
        "onLogout"
    };

    QtMocHelpers::UintData qt_methods {
        // Slot 'onAddStudentClicked'
        QtMocHelpers::SlotData<void()>(1, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'onDeleteStudentClicked'
        QtMocHelpers::SlotData<void()>(3, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'onCreateCourseClicked'
        QtMocHelpers::SlotData<void()>(4, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'onAssignInstructorClicked'
...
void AdminDashboard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->onAddStudentClicked(); break;
        case 1: _t->onDeleteStudentClicked(); break;
        case 2: _t->onCreateCourseClicked(); break;
        case 3: _t->onAssignInstructorClicked(); break;
